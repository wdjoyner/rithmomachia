...
Structural ideas for scenes to be described in animation_sequence

* all pieces are setup in their starting position, intially.
* explain using highlighted squares/pieces the different patterns:
 * deemed as a sort of social standing among numbers
 * numbers in one of the 3 progressions (arithmetic, geometric,
   harmonic - as described below)
 * arithmetic prorgessions - define them and give examples
   * uncapture/un-move those pieces
 * geometric progressions  - define them and give examples
   * uncapture/un-move those pieces
 * harmonic progressions   - define them and give examples
   * uncapture/un-move those pieces

This is lesson 6, based on the blender python module rithmomachia_pieces_blender+text_piece-lesson3c

last modified by wdj on 2025-08-22
"""
import bpy
import math
import copy
...
# Custom Game Board configuration
INITIAL_GAME_BOARD = [
...
def highlight_piece(piece_obj, start_frame, duration=30): ############ is this working???
    """
...
def create_educational_animation_sequence():
    ...
    Returns:
        list: A list of dictionaries, where each dictionary defines an
              animation scene.
    """
    # Text for the different scenes
    #this one is on progressions
    ...
    animation_sequence = [
        ...
        {
            'scene_type': 'text_and_highlight',
            'move_text': "  This tutorial explains what progressions are and how to use them to win.",
        ...
        {
            'scene_type': 'text_and_highlight',
            'move_text': "In rithmomachia, there are three types of victories. (1) Victory by siege: You win if your opponent can't make a legal move. ",
            'highlighted_pieces': [],
            'highlighted_empty_squares': [
            ],
            'pause': 10
        ...
        {
            'scene_type': 'text_and_highlight',
            'move_text': " (2) Common victories: You and your opponent agree beforehand on a number (such as 4 or 10) of enemy pieces that must be captured to declare a win. Alternatively, you can agree beforehand on the total value of enemy pieces that must be captured (such as 100 or 500 ) to declare a win. ",
            'highlighted_pieces': [],
            'highlighted_empty_squares': [
            ],
            'pause': 10
        ...
        {
            'scene_type': 'text_and_highlight',
            'move_text': " (3) Proper victories: You win once you have three friendly pieces whose values form a Progression all inside enemy territory (your opponent's half of the board).",
            'highlighted_pieces': [],
            'highlighted_empty_squares': [
            ],
            'pause': 10
        ...
        {
            'scene_type': 'text_and_highlight',
            'move_text': " This lesson explains what progressions are, so you can use this powerful method to win games. There are arithmetic, geometric and harmonic progressions.",
            'highlighted_pieces': [],
            'highlighted_empty_squares': [
            ],
            'pause': 10
        ...
        {
            'scene_type': 'text_and_highlight',
            'move_text': "Arithmetic Progression: values with constant difference (the 'step'). For example, 16,36,56 (with step 20).",
            'highlighted_pieces': [],
            'highlighted_empty_squares': [
                (0,13), # t16 
                (2,14), # t36 
        ...
        {
            'scene_type': 'text_and_highlight',
            'move_text': "Highlighted are the examples: 2,9,16 (with step 7) and 7,16,25 (with step 9).",
            'highlighted_pieces': [],
            'highlighted_empty_squares': [
                (4,12),(0,13),(3,13),            # 7,16,25
                (5,3),(7,2),(4,2),          # 2,9,16
            ],
            'pause': 10
        },
        ...
        {
            'scene_type': 'text_and_highlight',
            'move_text': "Highlighted are the examples: 4,20,36 (with step 16) and 15,20,25 (with step 5).",
            'highlighted_pieces': [],
            'highlighted_empty_squares': [
                (4,1),(5,1),(7,1),            # 15, 20, 25
                (4,1),(5,2),(3,2),          # 4, 20, 36
            ],
            'pause': 10
        },
        ...
        {
            'scene_type': 'text_and_highlight',
            'move_text': "Highlighted are the examples: 28, 64, 100 (with step 36) and 49, 169, 289 (with step 120).",
            'highlighted_pieces': [],
            'highlighted_empty_squares': [
                (2,1),(1,0),(0,0),            # 49, 169, 289
                (0,14),(5,14),(7,13),          # 28, 64, 100
            ],
            'pause': 10
        },
        # all examples
        {
            'scene_type': 'text_and_highlight',
            'move_text': "There are many other examples besides these. Can you find any?",
            'highlighted_pieces': [],
            'highlighted_empty_squares': [
                (2,3),(3,3),(4,3),(5,3),       # white front circles
                (2,12),(3,12),(4,12),(5,12),   # black front circles
                (4,12),(0,13),(3,13),            # 7,16,25
                (5,3),(7,2),(4,2),          # 2,9,16
                (4,1),(5,1),(7,1),            # 15, 20, 25
                (0,13),(2,14),(4,14),          # 16, 36, 56
                (2,1),(1,0),(0,0),            # 49, 169, 289
                (0,14),(5,14),(7,13),          # 28, 64, 100
            ],
            'pause': 10
        ...
        {
            'scene_type': 'text_and_highlight',
            'move_text': "Geometric Progression: values with constant ratios. Example with White circles: 2,4,8 (with ratio 2).",
            'highlighted_pieces': [],
            'highlighted_empty_squares': [(5,3),(4,3),(2,3)],
            'pause': 10
        },
        #    Scene 5d: 
        {
        ...
        {
            'scene_type': 'text_and_highlight',
            'move_text': "Another example: 4,16,64 (with ratio 4).",
            'highlighted_pieces': [],
            'highlighted_empty_squares': [(5,2),(4,2),(2,2)],
            'pause': 10
        },
        #    Scene 5d: 
        {
        ...
        {
            'scene_type': 'text_and_highlight',
            'move_text': "Yet another example: 9,12,16 (with ratio 4/3).",
            'highlighted_pieces': [],
            'highlighted_empty_squares': [(0,13),(1,13),(2,13)],
            'pause': 10
        },
        #    Scene 5d: 
        {
        ...
        {
            'scene_type': 'text_and_highlight',
            'move_text': "One more example: 81,153,289 (with ratio 17/9).",
            'highlighted_pieces': [],
            'highlighted_empty_squares': [(0,2),(0,1),(0,0)],
            'pause': 18
        },
        #    Scene 5d: 
        {
        ...
        {
            'scene_type': 'text_and_highlight',
            'move_text': "Yet another example: 81,90,100 (with ratio 10/9).",
            'highlighted_pieces': [],
            'highlighted_empty_squares': [(5,13),(6,13),(7,13)],
            'pause': 18
        },
        # all examples
        {
            'scene_type': 'text_and_highlight',
            'move_text': "There are many other examples besides these. Can you find some?",
            'highlighted_pieces': [],
            'highlighted_empty_squares': [
                (5,13),(6,13),(7,13), (6,0),(0,1),(0,0), (0,13),(1,13),(2,13),
                (5,2),(4,2),(2,2), (5,3),(4,3),(2,3), 
            ],
            'pause': 10
        },
        #    Scene 5d: 
        ...
        {
            'scene_type': 'text_and_highlight',
            'move_text': "Harmonic progression: 1/a, 1/b, 1/c forms an arithmetic progression. Classic example: 9,15,45 (with inverted step 2/45).",
            'highlighted_pieces': [],
            'highlighted_empty_squares': [(7,1),(6,1),(7,2)],  
            'pause': 10
        },
        {
            'scene_type': 'text_and_highlight',
            'move_text': "To be honest, there aren't many examples of this type of progression.  White's 9,16,72 is the only other (with inverted with step 7/144).",
            'highlighted_pieces': [],
            'highlighted_empty_squares': [(1,2),(4,2),(7,2)],
            'pause': 10
        },
        #    Scene 5d: 
        {
        ...
        {
            'scene_type': 'text_and_highlight',
            'move_text': "We call a 'fireteam', to borrow firefighting terminology, any three of your pieces whose values form a Progression. To win by Proper Victory: move a fireteam into enemy territory. ",
            'highlighted_pieces': [],
            'highlighted_empty_squares': [],
            'pause': 26
        },
        {
            'scene_type': 'text_and_highlight',
            'move_text': "The imaginative medieval monks believed that such a fireteam corresponds to three 'coordinated soldiers' inside the enemy fortress, which they equated with a victory.",
            'highlighted_pieces': [],
            'highlighted_empty_squares': [],
            'pause': 26
        },
        ...
        {
            'scene_type': 'text_and_highlight',
            'move_text': " Thank you for watching this video about progressions and winning methods in rithmomachia. This is Professor Pyramid signing off. I hope to see you in another rithmomachia lesson soon! ",
            'highlighted_pieces': [],
            'highlighted_empty_squares': [ ],
            'pause': 10
        },
...
def main_integrated_animation():
    ...
    #####################
    # This example creates 2,9,16 (with step 7) and 7,16,25 (step 9)
    stack_location = Vector((6 + 120, -7, 0)) # Position it to the left-center of the board
    text_obj = create_3d_text(
    text="2 + 7 = 9, 9 + 7 = 16, and .  .  .  .     7 + 9 = 16, 16 + 9 = 25.",
    location=stack_location,
    font_size=1.0,
    ...
    #####################
    # This example creates 4,20,36 (with step 16) and 15,20,25 (with step 5)
    stack_location = Vector((6 + 130, -7, 0)) # Position it to the left-center of the board
    text_obj = create_3d_text(
    text="4 + 16 = 20, 20 + 16 = 36, and .  .  .  .  .  15 + 5 = 20, 20 + 5 = 25",
    location=stack_location,
    font_size=0.9,
    color_name="off_white",
    color_rgba=(0.6, 0.7, 0.7, 1.0),
    ...
    #####################
    # This example creates 28,64,100 (with step 36) and 49,169,289 (with step 120)
    stack_location = Vector((6 + 140, -7, 0)) # Position it to the left-center of the board
    text_obj = create_3d_text(
    text="28 + 36 = 64, 64 + 36 = 100, and .  .  .  .  .     49 + 120 = 169, 169 + 120 = 289  ",
    location=stack_location,
    font_size=0.8,
    color_name="off_white",
    color_rgba=(0.6, 0.7, 0.7, 1.0),
    ...
    #    #####################
    # Create 9,15,45 (with inverted step 2/45)
    stack_location = Vector((6 + 190, -7, 0)) # Position it to the left-center of the board
    text_obj = create_3d_text(
    text="(1/45) + (2/45) = (1/15), (1/15) + (2/45) = (1/9).",
    location=stack_location,
    font_size=0.6,
    color_name="off_white",
    color_rgba=(0.6, 0.7, 0.7, 1.0),
