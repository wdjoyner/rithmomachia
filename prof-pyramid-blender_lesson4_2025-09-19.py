...
(rithmomachia_pieces_blender+capture3d.py) and adds Prof Pyramid, etc



Last Modified by wdj: 2025-09-19
...
def create_educational_animation_sequence():
    ...
    animation_sequence = [
         ...
         #   'pause': 20
         #},
        # Scene 0: An introduction to captures
        {
            'scene_type': 'text_and_highlight',
            'move_text': "  In this tutorial we learn how the pieces capture.    ",
            'highlighted_pieces': [], # Example of highlighting white pieces
            'highlighted_empty_squares': [],
            'pause': 10,
        },
        # Scene 1: An introduction to the pieces with highlights
        # This scene focuses on text and highlighting the white pieces without any movement.
        {
            'scene_type': 'text_and_highlight',
            'move_text': "There are Six methods in which you can capture an opposing piece. Each method usually involves piece values in some way. ",
            'highlighted_pieces': [], # Example of highlighting white pieces
            'highlighted_empty_squares': [(0,10),(0,13),(1,9),(1,13),(3,2),(3,8),(4,11),(4,3),(4,2),(4,1),(4,12),(5,11),(5,12),(5,2),(6,8),(7,2),(7,4)],
            'pause': 10,
        },
        # Scene 2: 
        {
            'scene_type': 'text_and_highlight',
            'move_text': "Each method is explained using the highlighted examples in the study below. ",
            'highlighted_pieces': [], # Example of highlighting white pieces
            'highlighted_empty_squares': [(0,10),(0,13),(1,9),(1,13),(3,2),(3,8),(4,11),(4,3),(4,2),(4,1),(4,12),(5,11),(5,12),(5,2),(6,8),(7,2),(7,4)],
            'pause': 10,
        },
        ...
        {
            'scene_type': 'text_and_highlight',
            'move_text': "1. Capture by number. A friendly piece of value v can Capture By Number an opposing piece only if ",
            'highlighted_pieces': [], # Example of highlighting white pieces
            'highlighted_empty_squares': [(7,4),(7,2) ],
            'pause': 10,
        },
        # Scene 4: 
        {
            'scene_type': 'text_and_highlight',
            'move_text': " (a) the friendly piece is exactly One move away from the opposing piece, and ",
            'highlighted_pieces': [], # Example of highlighting white pieces
            'highlighted_empty_squares': [ (7,4),(7,2) ],
            'pause': 10,
        },
        ...
        {
            'scene_type': 'text_and_highlight',
            'move_text': " (b) the opposing piece also has value v.",
            'highlighted_pieces': [], # Example of highlighting white pieces
            'highlighted_empty_squares': [ (7,4),(7,2) ],
            'pause': 10,
        },
        # Scene 5b: A capture for a piece
        {
        ...
        {
            'scene_type': 'text_and_highlight',
            'move_text': " A number capture example: T009 can take c009 by number, if it's White's turn.",
            'highlighted_pieces': [], # Example of highlighting white pieces
            'highlighted_empty_squares': [ (7,4),(7,2) ],
            'pause': 10,
        },
        # Scene 6b: A capture for a circle piece
        {
            'scene_type': 'move_piece',
            'piece_name': 'c009_2',
            'steps': (-50, 50),
        ...
        # Scene 6b2: A un-capture for a piece
        {
            'scene_type': 'move_piece',
            'piece_name': 'Graphic_SumFormula1',
            'steps': (110, 0),
        ...
        {
            'scene_type': 'text_and_highlight',
            'move_text': "What if it's Black's turn? Are there any number captures then?",
            'highlighted_pieces': [], # Example of highlighting white pieces
            'highlighted_empty_squares': [ (7,4),(7,2) ],
            'pause': 10,
        },
        # Scene 6d: An un-capture for a circle piece
        {
            'scene_type': 'move_piece',
            'piece_name': 'c009_2',
            'steps': (50, -50),
        ...
        {
            'scene_type': 'text_and_highlight',
            'move_text': "In this case, if it's Black's turn the c009 Cannot take T009 by number, since the circle is Two moves away.",
            'highlighted_pieces': [], # Example of highlighting white pieces
            'highlighted_empty_squares': [ (7,4),(7,2) ],
            'pause': 10,
        },
        ...
        {
            'scene_type': 'text_and_highlight',
            'move_text': "2. Capture by sum. Two friendly pieces of values v1 and v2 can Capture By Sum an opposing piece only if",
            'highlighted_pieces': [], # Example of highlighting white pieces
            'highlighted_empty_squares': [(5, 12), (4, 11), (5, 11)],
            'pause': 10,
        },
        # Scene 9: 
        {
            'scene_type': 'text_and_highlight',
            'move_text': "(a) each friendly piece is exactly One move away from the opposing piece (with no pieces in-between), and ",
            'highlighted_pieces': [], # Example of highlighting white pieces
            'highlighted_empty_squares': [(5, 12), (4, 11), (5, 11)],
            'pause': 10,
        },
        ...
        {
            'scene_type': 'text_and_highlight',
            'move_text': " (b) the opposing piece has value v1 + v2. ",
            'highlighted_pieces': [], # Example of highlighting white pieces
            'highlighted_empty_squares': [(5, 12), (4, 11), (5, 11)],
            'pause': 10,
        },
        ...
        # Scene 11a: 
        # (c007+c009)xC016 (by addition)                          C016 = (5, 11)   c009 = (5, 12)  c007 = (4, 11)
        {
            'scene_type': 'text_and_highlight',
            'move_text': " A sum capture example: the pair c007 and c009 can capture C016, if it's Black's turn. ",
            'highlighted_pieces': [], # Example of highlighting white pieces
            'highlighted_empty_squares': [(5, 12), (4, 11), (5, 11)],
            'pause': 10,
        },
        # Scene 11b: A capture for a circle piece
        {
            'scene_type': 'move_piece',
            'piece_name': 'C016_1',
            'steps': (-50, 50),
        ...
        {
            'scene_type': 'text_and_highlight',
            'move_text': " But no such capture exists when it's White's turn.",
            'highlighted_pieces': [], # Example of highlighting white pieces
            'highlighted_empty_squares': [ (5, 12), (4, 11), (5, 11) ],
            'pause': 10,
        },
        # Scene 11d: An un-capture for a circle piece
        {
            'scene_type': 'move_piece',
            'piece_name': 'C016_1',
            'steps': (50, -50),
        ...
        {
            'scene_type': 'text_and_highlight',
            'move_text': "3. Capture by difference. Two friendly pieces of values v1 and v2 can Capture By Difference an opposing piece only if",
            'highlighted_pieces': [], # Example of highlighting white pieces
            'highlighted_empty_squares': [(5, 12), (4, 11), (4, 12)],
            'pause': 10,
        },
        # Scene 13: 
        {
            'scene_type': 'text_and_highlight',
            'move_text': " (a) each friendly piece is one move away from the opposing piece, and ",
            'highlighted_pieces': [], # Example of highlighting white pieces
            'highlighted_empty_squares': [(5, 12), (4, 11), (4, 12)],
            'pause': 10,
        },
        ...
        {
            'scene_type': 'text_and_highlight',
            'move_text': " (b) the opposing piece has value v2 - v1. ",
            'highlighted_pieces': [], # Example of highlighting white pieces
            'highlighted_empty_squares': [(5, 12), (4, 11), (4, 12)],
            'pause': 10,
        },
        ...
        # Scene 15a: 
        # (c009-c009)xC002 (by difference)                        C002 = (4, 12)   c009 = (5, 12)  c007 = (4, 11)
        {
            'scene_type': 'text_and_highlight',
            'move_text': "A difference capture example: c009 with c007 can together capture C002, if it's Black's turn. ",
            'highlighted_pieces': [], # Example of highlighting white pieces
            'highlighted_empty_squares': [(5, 12), (4, 11), (4, 12)],
            'pause': 10,
        },
        # Scene 15b: A capture for a circle piece
        {
            'scene_type': 'move_piece',
            'piece_name': 'C002_1',
            'steps': (-50, 50),
        ...
        {
            'scene_type': 'text_and_highlight',
            'move_text': " But not if it's White's turn.",
            'highlighted_pieces': [], # Example of highlighting white pieces
            'highlighted_empty_squares': [ (5, 12), (4, 11), (5, 11), (4,12) ],
            'pause': 10,
        },
        # Scene 15d: An un-capture for a circle piece
        {
            'scene_type': 'move_piece',
            'piece_name': 'C002_1',
            'steps': (50, -50),
        ...
        # Scene 5b: A uncapture for a piece
        {
            'scene_type': 'move_piece',
            'piece_name': 'Graphic_SumFormula3',
            'steps': (130, 0),
        ...
        {
            'scene_type': 'text_and_highlight',
            'move_text': "This capture is not 'symmetric' like some other capture methods.",
            'highlighted_pieces': [], # Example of highlighting white pieces
            'highlighted_empty_squares': [(5, 12), (4, 11), (5, 11), (4, 12)],
            'pause': 10,
        },
        ...
        {
            'scene_type': 'text_and_highlight',
            'move_text': "Indeed, if it's White's turn, C002 and C016 Cannot capture by sum or by difference, since the sum (18) and difference (14) don't match any piece values. ",
            'highlighted_pieces': [], # Example of highlighting white pieces
            'highlighted_empty_squares': [(5, 12), (4, 11), (5, 11), (4, 12)],
            'pause': 10,
        },
        # Scene 17: C008 = (0, 10),  t016 = (0, 13)
                   # C004xt012 and           t012xC004 (by mult or div)      C004 = (1, 9)    t012 = (1, 13)
                   # T006xc003 and           c003xT006 (by mult or div)      T006 = (6, 8)    c003 = (3, 8)
        {
            'scene_type': 'text_and_highlight',
            'move_text': "4. Capture by multiple. A friendly piece of value v can Capture By Multiple an opposing piece only if",
            'highlighted_pieces': [], # Example of highlighting white pieces
            'highlighted_empty_squares': [(0, 10), (0, 13), (1, 9), (1, 13), (6, 8), (3, 8), (7,2), (7,4)],
            'pause': 10,
        },
        # Scene 18: 
        {
            'scene_type': 'text_and_highlight',
            'move_text': " (a) the friendly piece is exactly d unoccupied squares away from the opposing piece (d>0 an integer), and ",
            'highlighted_pieces': [], # Example of highlighting white pieces
            'highlighted_empty_squares': [(0, 10), (0, 13), (1, 9), (1, 13), (6, 8), (3, 8), (7,2), (7,4)],
            'pause': 10,
        },
        ...
        {
            'scene_type': 'text_and_highlight',
            'move_text': " (b) the opposing piece has value dv and is on the same rank or the same file as the friendly piece. ",
            'highlighted_pieces': [], # Example of highlighting white pieces
            'highlighted_empty_squares': [(0, 10), (0, 13), (1, 9), (1, 13), (6, 8), (3, 8), (7,2), (7,4)],
            'pause': 10,
        },
        ...
        {
            'scene_type': 'text_and_highlight',
            'move_text': "A multiple capture example: C008 can capture by multiple t016 (d = 2), if it's White's turn. ",
            'highlighted_pieces': [], # Example of highlighting white pieces
            'highlighted_empty_squares': [(0, 10), (0, 13)],
            'pause': 10,
        },
        # Scene 20b: A capture for a black triangle piece
        {
            'scene_type': 'move_piece',
            'piece_name': 't016_1',
            'steps': (-50, 50),
        ...
        {
            'scene_type': 'text_and_highlight',
            'move_text': "What if it's Black's turn? In that case, there's another capture method which Does allow Black a capture. We'll get to it - be patient!",
            'highlighted_pieces': [], # Example of highlighting white pieces
            'highlighted_empty_squares': [ (7,4),(7,2) ],
            'pause': 10,
        },
        # Scene 20d: An un-capture for a circle piece
        {
            'scene_type': 'move_piece',
            'piece_name': 't016_1',
            'steps': (50, -50),
        ...
        {
            'scene_type': 'text_and_highlight',
            'move_text': " Another multiple capture example: c009 can take T009 (d = 1), if it's Black's turn. ",
            'highlighted_pieces': [], # Example of highlighting white pieces
            'highlighted_empty_squares': [(7,2), (7,4)],
            'pause': 10,
        },
        # Scene 21b: A capture for a white triangle piece
        {
            'scene_type': 'move_piece',
            'piece_name': 'T009_1',
            'steps': (-50, 50),
        ...
        # Scene 21d: An un-capture for that piece
        {
            'scene_type': 'move_piece',
            'piece_name': 'T009_1',
            'steps': (50, -50),
        ...
        {
            'scene_type': 'text_and_highlight',
            'move_text': "Likewise, T009 can capture by multiple c009 (d = 1), if it's White's turn. As we saw above, it can capture by number as well. ",
            'highlighted_pieces': [], # Example of highlighting white pieces
            'highlighted_empty_squares': [(7,2), (7,4)],
            'pause': 10,
        },
        ...
        {
            'scene_type': 'text_and_highlight',
            'move_text': "The study position has several other possible captures by multiple. Can you find them? (Pause the video if needed.)",
            'highlighted_pieces': [], # Example of highlighting white pieces
            'highlighted_empty_squares': [],
            'pause': 10,
        },
        ...
        {
            'scene_type': 'text_and_highlight',
            'move_text': "All possible captures by multiple in this study position are highlighted.  Did you find them?",
            'highlighted_pieces': [], # Example of highlighting white pieces
            'highlighted_empty_squares': [(0, 10), (0, 13), (1, 9), (1, 13),  (3, 8),(6, 8), (7,2), (7,4)],
            'pause': 10,
        },
        # Scene 24: 
        {
            'scene_type': 'text_and_highlight',
            'move_text': "5. Capture by divisor. A friendly piece of value v can Capture by Divisor an opposing piece only if",
            'highlighted_pieces': [], # Example of highlighting white pieces
            'highlighted_empty_squares': [(0, 10), (0, 13), (1, 9), (1, 13), (6, 8), (3, 8), (7,2), (7,4)],
            'pause': 10,
        },
        ...
        {
            'scene_type': 'text_and_highlight',
            'move_text': "(a) the friendly piece is exactly d unoccupied squares away from the opposing piece, and ",
            'highlighted_pieces': [], # Example of highlighting white pieces
            'highlighted_empty_squares': [(0, 10), (0, 13), (1, 9), (1, 13), (6, 8), (3, 8), (7,2), (7,4)],
            'pause': 10,                                             ## approx=  len(s)/4.8     (4.8 = 24/5, 5 = letters per second in spoken english)  
        },
        # Scene 26: 
        {
            'scene_type': 'text_and_highlight',
            'move_text': " (b) the opposing piece has value v/d (and d must divide v) and is on the same rank or the same file as the friendly piece. ",
            'highlighted_pieces': [], # Example of highlighting white pieces
            'highlighted_empty_squares': [(0, 10), (0, 13), (1, 9), (1, 13), (6, 8), (3, 8), (7,2), (7,4)],
            'pause': 10,
        },
        ...
        {
            'scene_type': 'text_and_highlight',
            'move_text': "A divisor capture example: t016 can capture by divisor C008 (d = 2), if it's Black's turn. ",
            'highlighted_pieces': [], # Example of highlighting white pieces
            'highlighted_empty_squares': [(0, 10), (0, 13)],
            'pause': 10,                                                   ## approx=  len(s)/4.8     (4.8 = 24/5, 5 = letters per second in spoken english)  
        },
        # Scene 27b: A capture for a white circle piece
        {
            'scene_type': 'move_piece',
            'piece_name': 'C008_1',
            'steps': (-50, 50),
        ...
        {
            'scene_type': 'text_and_highlight',
            'move_text': " We'll put this back for later.",
            'highlighted_pieces': [], # Example of highlighting white pieces
            'highlighted_empty_squares': [ (0,10),(0,13) ],
            'pause': 10,                                                 ## approx=  len(s)/4.8     (4.8 = 24/5, 5 = letters per second in spoken english)  
        },
        # Scene 27d: An un-capture for that piece
        {
            'scene_type': 'move_piece',
            'piece_name': 'C008_1',
            'steps': (50, -50),
        ...
        # Scene 21b: A uncapture for a white triangle piece
        {
            'scene_type': 'move_piece',
            'piece_name': 'Graphic_SumFormula6',
            'steps': (160, 0),
        ...
        {
            'scene_type': 'text_and_highlight',
            'move_text': " The study position has several other possible captures by divisor. Can you find them? (Pause the video if you need to!)",
            'highlighted_pieces': [], # Example of highlighting white pieces
            'highlighted_empty_squares': [],
            'pause': 10,
        },
        ...
        {
            'scene_type': 'text_and_highlight',
            'move_text': " The other possible captures by divisor in this study position are highlighted. Did you find them? ",
            'highlighted_pieces': [], # Example of highlighting white pieces
            'highlighted_empty_squares': [(0, 10), (0, 13), (1, 9), (1, 13), (6, 8), (3, 8), (7,2), (7,4)],
            'pause': 10,                                                      ## approx=  len(s)/4.8     (4.8 = 24/5, 5 = letters per second in spoken english)  
        },
        ...
        {
            'scene_type': 'text_and_highlight',
            'move_text': "A divisor capture example: One divisor capture is t012 takes C004 (d = 3), but now t012 attacks T072 (d = 6)! Did you see that 2nd capture?  Capturing two pieces in this way is called a 'chain capture'.",
            'highlighted_pieces': [], # Example of highlighting white pieces
            'highlighted_empty_squares': [(0, 10), (0, 13), (1, 9), (1, 13), (6, 8), (3, 8), (7,2), (7,4), (1,6)],
            'pause': 10,                                                      ## approx=  len(s)/4.8     (4.8 = 24/5, 5 = letters per second in spoken english)  
        },
        # Scene 29:  (by siege)    C006 = (4, 3)    c005 = (4, 2)    C004 = (5, 2)     T020 = (4, 1)    C036 = (3, 2)
        {
            'scene_type': 'text_and_highlight',
            'move_text': "6. Capture by siege. Four friendly pieces of any value can Capture By Siege an opposing piece only if",
            'highlighted_pieces': [], # Example of highlighting white pieces
            'highlighted_empty_squares': [(4,3), (4,2), (5,2), (4,1), (3,2)],
            'pause': 10,                                                      ## approx=  len(s)/4.8     (4.8 = 24/5, 5 = letters per second in spoken english)  
        },
        # Scene 21b: A uncapture for a white triangle piece
        {
        ...
        {
            'scene_type': 'text_and_highlight',
            'move_text': " they surround the opposing piece on each side preventing its movement. This capture doesn't involve piece values.",  ### = s
            'highlighted_pieces': [],                                                   # Example of highlighting  pieces
            'highlighted_empty_squares': [(4,3), (4,2), (5,2), (4,1), (3,2)],
            'pause': 10,                                                                ## approx=  len(s)/4.8     (4.8 = 24/5, 5 = letters per second in spoken english)            
        },
        # Scene 30aa: 
        {
            'scene_type': 'text_and_highlight',
            'move_text': " The siege configuration is like a statemate in chess. Examples stick out like a sore thumb, don't they?",  ### = s
            'highlighted_pieces': [],                                                   # Example of highlighting  pieces
            'highlighted_empty_squares': [(4,3), (4,2), (5,2), (4,1), (3,2)],
            'pause': 10,                                                                ## approx=  len(s)/4.8     (4.8 = 24/5, 5 = letters per second in spoken english)            
        },
        # Scene 30b: A capture for a white circle piece
        {
            'scene_type': 'move_piece',
            'piece_name': 'c005_1',
            'steps': (-50, 50),
        ...
        # Scene 30c: 
        {
            ...
            'move_text': " We'll put this back for later.",
            'highlighted_pieces': [], # Example of highlighting white pieces
            'highlighted_empty_squares': [ (4,3), (5,2), (4,1), (3,2) ],
            'pause': 30
        },
        # Scene 30d: An un-capture for that piece
        {
            'scene_type': 'move_piece',
            'piece_name': 'c005_1',
            'steps': (50, -50),
        ...
        # Scene 31:  (by siege)    C006 = (4, 3)    c005 = (4, 2)    C004 = (5, 2)     T020 = (4, 1)    C036 = (3, 2)
        {
            'scene_type': 'text_and_highlight',
            'move_text': " If the opposing piece was at the side of the board, only three friendly pieces are needed to capture by siege. Usually, you need four.",
            'highlighted_pieces': [], # Example of highlighting white pieces
            'highlighted_empty_squares': [(4,3), (4,2), (5,2), (4,1), (3,2)],
            'pause': 10,
        },
        ...
        {
            'scene_type': 'text_and_highlight',
            'move_text': "Note: in rithmomachia, you can capture more than one opposing piece on the same turn, like in checkers.",
            'highlighted_pieces': [], # Example of highlighting white pieces
            'highlighted_empty_squares': [],
            'pause': 10,
        },
        ...
        {
            'scene_type': 'text_and_highlight',
            'move_text': "Also note, in rithmomachia the capturing piece(s) need not move.",
            'highlighted_pieces': [], # Example of highlighting white pieces
            'highlighted_empty_squares': [],
            'pause': 10,
        },
        ...
        {
            'scene_type': 'text_and_highlight',
            'move_text': "That's it! We covered all the methods to capture a piece, except for the Pyramid piece which will be covered in another lesson. Good luck!",
            'highlighted_pieces': [], # Example of highlighting white pieces
            'highlighted_empty_squares': [],
            'pause': 10,
        },
        ...
        {
            'scene_type': 'text_and_highlight',
            'move_text': " Thank you for watching this video about capturing methods (except for the Pyramid). This is Professor Pyramid signing off. I hope to see you in another rithmomachia lesson soon! ",
            'highlighted_pieces': [],
            'highlighted_empty_squares': [ ],
            'pause': 10
        },
...
def main_integrated_animation():
    ...
    game_state = copy.copy(CUSTOM_GAME_BOARD2)
    ...
    # This example creates value T009 = 9, value c009 = 9
    stack_location = Vector((6+110, -7, 0.0)) # Position it to the left-center of the board
    text_obj = create_3d_text(
    text="The value of T9 is 9  and the  value of c9 is also 9.",
    ...
    #####################
    # This example creates 8x2 = 16
    stack_location = Vector((6 + 140, -7, 0)) # Position it to the left-center of the board
    text_obj = create_3d_text(
    text="8 times 2 = 16   and  C8 is distance d=2 from t16  ",
    location=stack_location,
    font_size=0.8,
    color_name="off_white",
    color_rgba=(0.6, 0.7, 0.7, 1.0),
    ...
    text_obj = create_3d_text(
    text="9 times 1 = 9   and  c9 is distance d=1 from T9.",
    location=stack_location,
    font_size=0.9,
    color_name="off_white",
    color_rgba=(0.6, 0.7, 0.7, 1.0),
